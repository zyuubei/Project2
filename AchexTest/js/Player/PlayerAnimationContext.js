...
phina.define('PlayerAnimationContext', {
  ...
  init: function(playerObj, headImage, bodyImage) {
    ...
    this._guardStandAnim  = PlayerAnimation4(this, this.headImage, this.bodyImage, Animation4Front, Animation4Left, Animation4Right, Animation4Back);  // 歩きグラフィックアニメーション    
    this._guardWalkAnim   = PlayerAnimation5(this, this.headImage, this.bodyImage, Animation5Front, Animation5Left, Animation5Right, Animation5Back);  // 歩きグラフィックアニメーション    
    this._jumpAnim        = PlayerAnimation6(this, this.headImage, this.bodyImage, Animation6Front, Animation6Left, Animation6Right, Animation6Back);  // 歩きグラフィックアニメーション    
    this._slidingAnim     = PlayerAnimation7(this, this.headImage, this.bodyImage, Animation7Front, Animation7Left, Animation7Right, Animation7Back);  // 歩きグラフィックアニメーション    
    ...
    this.animDict = {
      ...
      jump:this._jumpAnim,
      guardSliding:this._slidingAnim
    };
